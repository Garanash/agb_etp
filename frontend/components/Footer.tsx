        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Алмазгеобур ЭТП</span>
            </div>
            <p className="text-secondary-300 mb-4">
              Электронная торговая площадка для компании Алмазгеобур. 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/tenders" className="text-secondary-300 hover:text-white transition-colors">
                  Тендеры
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/contacts" className="text-secondary-300 hover:text-white transition-colors">
                  Контакты
                </Link>
              </li>
              <li>
                <Link href="/register" className="text-secondary-300 hover:text-white transition-colors">
                  Регистрация
                </Link>
              </li>
            </ul>
